...
const ERROR_TITLES: Record<ErrorCode, string> = {
  ...
  DOMAIN_NOT_ALLOWED: "SEÑAL NO AUTORIZADA",
  VIDEO_NOT_FOUND: "SEÑAL PERDIDA",
  PRIVATE_VIDEO: "SEÑAL BLOQUEADA",
  AUTHENTICATION_REQUIRED: "ACCESO DENEGADO",
  AGE_RESTRICTED: "SEÑAL RESTRINGIDA",
  LIVE_NOT_SUPPORTED: "TRANSMISIÓN EN VIVO",
  PLAYLIST_NOT_SUPPORTED: "SEÑAL MÚLTIPLE",
  DURATION_LIMIT_EXCEEDED: "SEÑAL EXTENSA",
  SIZE_LIMIT_EXCEEDED: "SEÑAL PESADA",
  ANALYSIS_TIMEOUT: "SEÑAL LENTA",
  YTDLP_ERROR: "INTERFERENCIA DETECTADA",
  SERVER_CONFIGURATION_ERROR: "ERROR DE SISTEMA",
